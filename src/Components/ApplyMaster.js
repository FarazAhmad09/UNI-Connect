...
export default function ApplyMaster() {
                    ...
                    <div className="max-w-xl">
                        ...
                        <div>
                            <h4 className=" font-normal text-gray-900 mt-5" style={{ display: "flex" }} >
                                <a href="/" className="under-text-line" style={{ fontSize: "1.25rem", }} >How to log into Universityadmissions.se</a>
                        ...
                        <div>
                            <h4 className=" font-normal text-gray-900 mt-5" style={{ display: "flex" }} >
                                <a href="/" className="under-text-line" style={{ fontSize: "1.25rem", }} >If you've previously applied</a>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 under-text-line ml-2 mt-2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                                </svg>
                            </h4>
