...
export default function EventThreeDetail() {
        ...
        <>
            ...
            <section className="mt-8 mx-auto max-w-screen-xl pb-4 px-4 sm:px-8 mb-5">
                <div className="mt-12 justify-center items-center space-y-3 sm:space-x-6 sm:space-y-0 sm:flex">
                    <img src="https://crijade.com/mL4eP8sA/wp-content/uploads/2024/03/20240327_134256-scaled.jpg" alt="" width={"100%"} height={"100%"} />
                </div>
                <div className=" space-y-4 mt-5">
                    <h1 className="text-gray-800 font-bold text-4xl md:text-3xl">
                        3rd International Conference on Engineering and Computing Technologies (ICECT 2024)
                        <span className="text-indigo-600"> Event</span>
                    </h1>
                    <p className="text-gray-500 max-w-xcl  leading-relaxed">
                        The 3rd International Conference on Engineering and Computing Technologies (ICECT 2024) promises to be a dynamic gathering of innovators, scholars, and practitioners from around the globe. Scheduled to take place on [insert date], this event is set to push the boundaries of knowledge in engineering and computing.
                    </p>
                    <p className="text-gray-500 max-w-xcl  leading-relaxed">
                        With a diverse range of topics and sessions, ICECT 2024 will provide a platform for exchanging ideas, fostering collaborations, and exploring the latest advancements in various engineering and computing domains. Participants can expect stimulating discussions, insightful presentations, and hands-on workshops tailored to meet the evolving needs of the industry.
                    </p>
                    <div className="mt-3">
