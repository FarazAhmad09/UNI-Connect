...
export default function EventTwoDetail() {
        ...
        <>
            ...
            <section className="mt-8 mx-auto max-w-screen-xl pb-4 px-4 sm:px-8 mb-5">
                <div className="mt-12 justify-center items-center space-y-3 sm:space-x-6 sm:space-y-0 sm:flex">
                    <img src="https://thesocialinstitute.com/wp-content/uploads/iStock-1185581975-scaled.jpg" alt="" width={"100%"} height={"100%"} />
                </div>
                <div className=" space-y-4 mt-5">
                    <h1 className="text-gray-800 font-bold text-4xl md:text-3xl">
                        TA/ RA Opportunities for Students
                        <span className="text-indigo-600"> Event</span>
                    </h1>
                    <p className="text-gray-500 max-w-xcl  leading-relaxed">
                        Teaching Assistant (TA) and Research Assistant (RA) opportunities offer invaluable experiences for students, bridging the gap between academic learning and real-world application. As a TA, students typically assist professors in facilitating classes, grading assignments, and providing support to fellow students. This role not only enhances one's understanding of the subject matter but also fosters essential communication and leadership skills.
                    </p>
                    <div className="mt-3">
